<?php
	...
	require_once('config/data_structures.php');
...
';
	$referent->setVortrag(Vortrag::get('Körperliche Grenzen'));
...
';
	$referent->setVortrag(Vortrag::get('Völkerrecht'));
...
';
	...
	$referent->setVortrag(Vortrag::get('Europäische Union'));
